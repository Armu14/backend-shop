        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 rounded shadow mt-4">
                    <div class="card-body">
                        <h5><i class="fa fa-shopping-cart">DETAIL ORDER</i></h5>
                        <hr>
                        <table class="table" style="border-style: solid !important; border-color: rgp(198, 206, 214) !important;">
                            <tbody>
                                @foreach ($invoice->orders()->get() as $product)
                                    <tr style="background: #edf2f7;">
                                        <td class="b-none" width="25%">
                                            <div class="wrapper-image-cart">
                                                <img src="{{ $product->image }}" alt="" style="width: 100%; border-radius: .5rem;">
                                            </div>
                                        </td>
